...
using Aiursoft.MusicTools.Controllers;
...
namespace Aiursoft.MusicTools.Services;
    ...
    SignInManager<User> signInManager) : IScopedDependency
{
        ...
        UiStackLayoutViewModel toInject)
    {
        ...
        toInject.PageTitle = localizer[toInject.PageTitle ?? "View"];
        toInject.AppName = localizer["Music Tools"];
        ...
        {
            AppBrand = new Link { Text = localizer["Music Tools"], Href = "https://gitlab.aiursoft.com/aiursoft/musictools" },
            Links =
            [
